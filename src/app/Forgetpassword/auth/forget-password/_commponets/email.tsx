...
import { forgetSchema } from "@/schema/forgetpass.schema";
import { forgetSchemaForm } from "@/schema/forgetpass.schema";
  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        />
        <Button type="submit" className="ml-auto bg-green-500">
          Verity
        </Button>
      </form>
    </Form>
