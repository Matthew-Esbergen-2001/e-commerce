...
import { resetSchema } from "@/schema/resetpass.schema";
import { resetSchemaForm } from "@/schema/resetpass.schema";
    ...
    <Form {...form}>
      ...
      >
        ...
        <Button
          ...
          className="bg-green-500 text-white ml-auto block cursor-pointer hover:bg-main"
        >
